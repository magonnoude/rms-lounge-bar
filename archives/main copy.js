...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Désactiver l'ancienne initialisation du menu pour éviter les conflits
  const originalInit = menuManager.init;
  menuManager.init = function() {
    console.log('Initialisation du menu désactivée (déjà gérée par la correction)');
  };
  ...
  // Ne pas initialiser le menu ici - déjà fait par la correction
